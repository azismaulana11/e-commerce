          ...
          <div class="search-cell">
            <form action="/produk" method="GET">
              <div class="search-field-holder">
                <input type="search" class="form-control main-search-input" placeholder="Search for" name="search" value="{{ request('search') }}">
                ...
                <div class="collapse navbar-collapse text-center" id="navbar-collapse">
                  ...
                  <ul class="nav navbar-nav">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3 megamenu-item">
                                <ul class="menu-list">
                                  ...
                                  <li>
                                    <a href="/products/{{ $subcategory->id }}">{{$subcategory->nama_subkategori}}
                                    </a>
                                  </li>
                                  @endforeach
                                </ul>
                    ...
                    <li id="mobile-search" class="hidden-lg hidden-md">
                      <form method="get" class="mobile-search" action="/produk">
                        <input type="search" class="form-control" placeholder="Cari Produk" name="search">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="widget footer-about-us">
                  <h4>Azis Maulana</h4>
                  <p class="mb-30">Yuukaa Shop Alrights Reserved!</p>
                  <div class="footer-socials">
                    <div class="social-icons nobase">
                      <a href="https://facebook.com/azis74gaul"><i class="fa fa-facebook"></i></a>
                    </div>
                  </div>
                </div>
              </div> <!-- end about us -->
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 copyright sm-text-center">
                <span>
                  &copy; <?= date('Y') ?> Azis Maulana <a href="http://github.com/azismaulana11"> - Yuukaa</a>
                </span>
              </div>

  ...
  <div class="container-fluid semi-fluid">
    <div class="row">
      ...
      <div class="col-md-6 col-xs-12 product-description-wrap">
        ...
        <span class="discount">
          <ins>
            <span class="diskon">Diskon : Rp. {{ number_format($product->diskon) }}</span>
          </ins>
        </span>
        ...
        <div class="color-swatches clearfix">
          ...
          <input type="radio" name="color" id="{{ $loop->index }}" value="{{ $color }}" class="color">
          <label for="{{ $loop->index }}" style="margin-right: 20px">{{ $color }}</label>
          @endforeach
        </div>
          ...
          <div class="product-item hover-trigger">
            <div class="product-img">
              <a href="/product/{{ $latest_product->id }}">
                <img src="/uploads/{{ $latest_product->gambar }}" alt="">
                <img src="/uploads/{{ $latest_product->gambar }}" alt="" class="back-img">
              </a>
              ...
              <a href="/product/{{ $latest_product->id }}" class="product-quickview">Detail</a>
            </div>
            <div class="product-details">                      
              <h3 class="product-title">
                <a href="/product/{{ $latest_product->id }}">{{ $latest_product->nama_barang }}</a>
              </h3>
              <span class="category">
                <a href="/products/{{ $latest_product->id_subkategori }}">{{ $latest_product->subcategory->nama_subkategori }}</a>
              </span>
            </div>
            <span class="price">
              <ins>
  ...
  <script>
    $(function () {
      $('.add-to-cart').click(function(e) {
          ...
          total = {{ $product->harga }}*jumlah-diskon
          is_checkout = 0

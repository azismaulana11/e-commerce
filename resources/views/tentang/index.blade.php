                ...
                <div class="col-md-12">
                    <form class="form-tentang" method="POST" enctype="multipart/form-data" action="/tentang/{{ $about->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" class="form-control" placeholder="Deskripsi tentang" id="" cols="30" rows="10" required> {{ $about->deskripsi }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="">Alamat</label>
                            <textarea name="alamat" class="form-control" placeholder="Alamat tentang" id="" cols="30" rows="10" required>{{ $about->alamat }}</textarea>
                        </div>
                        <div class="form-group">

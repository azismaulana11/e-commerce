...
<div class="card shadow">
    ...
    <div class="card-body">
        <div class="d-flex justify-content-end item mb-4">
            ...
            <div class="col-md-12">
                <form class="form-subkategori">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi subkategori" id="" cols="30" rows="10" required></textarea>
                    </div>
                    <div class="form-group">

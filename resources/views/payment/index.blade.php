            ...
            <div class="col-md-12">
                <form class="form-kategori">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tanggal" placeholder="Tanggal" required readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Jumlah</label>
                        <input type="text" class="form-control" name="jumlah" placeholder="Jumlah" required readonly>
                    </div>
                    <div class="form-group">
                        <label for="">No Rekening</label>
                        <input type="text" class="form-control" name="no_rekening" placeholder="No Rekening" required readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Atas Nama</label>
                        <input type="text" class="form-control" name="atas_nama" placeholder="Atas Nama" required readonly>
                    </div>
                    <div class="form-group">
